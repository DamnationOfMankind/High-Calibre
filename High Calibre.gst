...
<gameSystem id="4728-e1b0-9a4c-5ecd" name="High Calibre" revision="3" battleScribeVersion="2.03" authorName="A.Bullard" authorContact="info@laserforgeminis.com" authorUrl="www.laserforgeminis.com" xmlns="http://www.battlescribe.net/schema/gameSystemSchema">
  <comment>Beta v0.2.1 Profiles Completed</comment>
  <costTypes>
...
-3 To Hit penalty for incoming aircraft Attack Runs.
    ...
    <rule id="2443-fd3d-a8f3-7494" name="Flotilla Leader" hidden="false">
      <description>This ship can only issue Orders to DD class ships and all DD ships within this ship&apos;s Division gain a +1 bonus to any Command Check
</description>
    </rule>
  </sharedRules>
  <sharedProfiles>
